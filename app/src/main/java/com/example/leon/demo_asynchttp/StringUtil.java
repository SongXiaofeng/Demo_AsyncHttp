...
//	}
	...
	/*
	 * 判断密码是否为8-16位 是否由字母与数字组成
	 */
	public static boolean isPassword(String passwordNum){
		if(passwordNum == null || passwordNum.trim().length() == 0){
			return false;
		}
		return password.matcher(passwordNum).matches();
	}
