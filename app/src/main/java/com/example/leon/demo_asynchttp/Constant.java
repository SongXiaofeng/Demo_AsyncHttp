...
public class Constant {
 //the debug switch whether record log, open function when true
    public static boolean LOG_DEBUG = false;//change to false when release
    
  //the debug switch whether display  user debug info, open function when true
    public static boolean TRACE_DEBUG = true;//change to false when release
    
  //the debug switch whether echo  update result to band, close function when true
    public static boolean UPDATE_DEBUG = false;//change to false when release
    
  //the debug switch whether auto update backgroud, close function when true
    public static boolean UPDATE_DEBUG1 = false;//change to false when release
	...
	public static final String PROTOCOL_ERRORCODE = "com.spark.PROTOCOL_ERRORCODE";
	...
	public static final String PROTOCOL_NOTICATION_SWITCH = "com.spark.PROTOCOL_NOTICATION_SWITCH";
	public static final String PROTOCOL_SEARCH = "com.spark.PROTOCOL_SEARCH";	
	public static final String PROTOCOL_ANTILOSS = "com.spark.PROTOCOL_ANTILOSS";		
	public static final String PROTOCOL_SPORTS_TYPE = "com.spark.PROTOCOL_SPORTS_TYPE";	
	public static final String PROTOCOL_SPORTS_GOALS = "com.spark.PROTOCOL_SPORTS_GOALS";	
	...
	public static final String PROTOCOL_NICEALARM_DATA = "com.spark.PROTOCOL_NICEALARM_DATA";
	public static final String PROTOCOL_NICEALARM_ALARM = "com.spark.PROTOCOL_NICEALARM_ALARM";
	...
	public static final String PROTOCOL_LOWPOWER_TOGLLE = "com.spark.PROTOCOL_LOWPOWER_TOGLLE";
...
//    public static final String FORMAT_H_M_S = "HH:mm:ss";
   ...
   // commitSportsDataList
	...
	public static final int NOWEAR = -1;//没有佩戴
	public static final int SOBER = 0;//清醒
	public static final int LIGHT_SLEEP = 1;//浅睡
	public static final int DEEP_SLEEP = 2;//深睡
	...
	public static final int MSG_SYNC_OVER = MSG_NET_ERROR + 1;
	...
	public static final int MSG_GET_HISTROYDB1 = MSG_GET_VERIFY_CODE + 1;	
    ...
    public static final int MSG_GET_DEVICE = MSG_TIME_OUT + 1;
	...
	public static final int MSG_INIT_RECYCLEVIEW_DAY = MSG_FRESH_SYNCH_TIME + 1;
	...
	// achievement
	public static final int GET_ACHIEVEMENT_SUCCESS = 11111;	
	public static final int GET_ACHIEVEMENT_FAIL = 11112;	
	public static final int SEND_ACHIEVEMENT_SUCCESS =11113;	
	public static final int SEND_ACHIEVEMENT_FAIL = 11114;
	public static final int HOME_TIME_TASK = 11151;
	public static final int HOME_STEP_TASK = 11161;
	public static final int DURATION_TIME_FORMAT = 123;
	public static final int ACHIEVEMENT_TIME_TASK=12121;
	public static final int HISTORY_DATA_TIME_TASK=12122;
	...
	public static final int GET_HISTROYDATA_FAIL=101;
	public static final int GET_HISTROYDATA_SUCESS=102;
